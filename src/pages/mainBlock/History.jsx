		...
		<Block underline={{ isUnderline: 'true', position: 'left' }}>
			...
			<div className={styles.content}>
				<div className={styles.text}>
					НБА начала свою жизнь как Баскетбольная ассоциация Америки в 1946
					году. Тогда туда входили 11 команд, а сегодня лига насчитывает
					30, среди которых команды, известные не только любителям
					баскетбола. Ассоциация является ведущей мужской профессиональной
					баскетбольной лигой и одной из четырех главных профессиональных
					спортивных лиг в США и ​​Канаде.
				</div>
				<div className={styles.text}>
					...
					корзины, куда предложил забрасывать мячи. Новость об игре стала
					распространяться по стране, и вскоре появились местные команды по
					баскетболу. Вслед за ними образовывались лиги. Они появлялись и
					исчезали одна за другой. Но две особенно выделялись: Национальная
					баскетбольная лига (НБЛ), основанная в 1937 году, и Баскетбольная
					ассоциация Америки (БАА).
				</div>
				<div
