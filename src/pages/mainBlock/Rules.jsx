		...
		<Block underline={{ isUnderline: 'true', position: 'left' }}>
			...
			<div className={styles.content}>
				<div className={styles.text}>
					...
					неофициальным регламентом и способами его нарушения. Расскажем о
					самых важных и интересных из них:
				</div>
				<ul className={styles.list}>
					...
					<li className={styles.item}>
						...
						около кольца связано с тем, что спортсмен был очень высокого
						роста – 208 см и веса – 114 кг. Он просто стоял у кольца и
						закидывал мячи, которые ему пасовали. Соперники возмущались,
						после чего было введено правило нахождения игроков у кольца.
					</li>
					<li className={styles.item}>
						Помеха попаданию мяча в кольцо также создана из-за Майкена.
						Как он ловко закидывал мячи в кольцо противника, так же хорошо
						он отбрасывал их от своего. Поэтому было введено правило,
						запрещающее трогать мяч, если он снижается после броска, но
						все еще находится выше корзины.
					</li>
					<li className={styles.item}>
						...
						красно-черные Air Jordan, ассоциация его оштрафовала на 5 000
						долларов. В итоге Nike сделал на этом неплохую рекламу и
						оплачивал все штрафы.
					</li>
				</ul>
			</div>
		</Block>
